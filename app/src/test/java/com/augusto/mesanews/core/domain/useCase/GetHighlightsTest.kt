...
class GetHighlightsTest {

    @Test
    fun `when NewsRepository getHighlights return Success GetHighlights return Success`() {
        runBlocking {
            ...
            val getHighlights = GetHighlights(newsRepository)
            Mockito.`when`(
            ...
            //act
            val returnGetNews = getHighlights.invoke()
